...
myletterText+='<tr><td colspan="2"><p class="bold" style=" ">enthaltene USt: 7,00 % aus <span id ="letter_price_the7">xxxx,xx</span> € = <span id="letter_price_the7Done">xxx,xx</span> € und 19,00 % aus <span id="letter_price_the19">xxxx,xx</span> € = <span id="letter_price_the19Done">x,xx</span> € </p></td>';
...
//alert(  $("#p_item33").val());
$('#price_the19').val(zz);
$('#price_the19Done').val((zz*.19).toFixed(2));
$('#letter_price_the19').text(zz.toFixed(2).replace(".", ","));
$('#letter_price_the19Done').text((zz*.19).toFixed(2).replace(".", ","));
totalKkPreis = zz;
//alert(zz)
}
...
var actual7X=$('#price_the7').val();
  ...
  $('#price_the7Done').val((actual7*.07).toFixed(2));
   $('#letter_price_the7').text(actual7.toFixed(2).replace(".", ","));
  $('#letter_price_the7Done').text((actual7*.07).toFixed(2).replace(".", ","));
...
else if(totalItemsPreis<=totalKkPreis) {biggerPreis=19;}
else if (totalItemsPreis>totalKkPreis) {biggerPreis=7;};
